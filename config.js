...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'Fedly',
  packname:  process.env.PACK_NAME || 'BOT⁴⁴⁴',
   
  botname:   process.env.BOT_NAME === undefined ? "Fedlytechyt" : process.env.BOT_NAME,
  ...
  OPENAI_API_KEY:  process.env.OPENAI_API_KEY === undefined ? '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' : process.env.OPENAI_API_KEY,
